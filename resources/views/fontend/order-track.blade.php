                ...
                <div class="card-body">
                    <article class="card">
                        <div class="card-body row" style="padding:10px;">
                            ...
                            @endphp
                                {{ $div }}, {{ $dis }}, {{ $state }} | <i class="fa fa-phone"></i> {{$order->phone}}</div>
                        ...
                        <li class="col col-md-3 col-sm-6  mt">
                            <figure class="itemside mb-3">
                                ...
                                <figcaption class="info align-self-center">
                                    <p class="title"> {{ $item->product->product_name_en }}</p> <span class="text-muted"><span class="badge badge-pill badge-primary qty"> {{$item->qty}}  pices</span> </span>
                                </figcaption>
                            </figure>
                        </li>
                    @endforeach
