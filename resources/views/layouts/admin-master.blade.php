...
<html lang="en">
  <head>
    ...
    <meta name="author" content="boiutso">
    ...
    <!-- tagsinput -->
    <link href="{{asset('admin/lib/tagsinput/bootstrap-tagsinput.min.js')}}" rel="stylesheet">
  ...
  <body>
    ...
    <script src="{{asset('admin/lib/tagsinput/bootstrap-tagsinput.min.js')}}"></script>
   ...
   <!-- sweetalert -->
   <script src="{{ asset('admin/lib/sweetalert/sweetalert.min.js') }}"></script>
    <script src="{{ asset('admin/lib/sweetalert/code.js') }}"></script>
   <script>
