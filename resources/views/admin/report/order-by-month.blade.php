...
<nav class="breadcrumb sl-breadcrumb">
	...
	<span class="breadcrumb-item active">Order List By Month</span>
</nav>
...
<div class="sl-pagebody">
	<div class="row row-sm">
		<div class="col-md-12">
	        <div class="card">
	          <h6 class="card-header">Order List By Month</h6>
		            ...
		            <table id="datatable1" class="table display responsive nowrap">
		              ...
		              <tbody>
		                  ...
		                  <td>
		                  	...
		                  	<a href="{{route('admin.invoice-download',$item->id)}}" class="btn btn-primary btn-sm"><i class="fa fa-download"></i></a>
		                  </td>
		                </tr>
		              	@endforeach
		              </tbody>
