    ...
    <div class="container">
        <div class="breadcrumb-inner">
            <ul class="list-inline list-unstyled">
                ...
                <li class='active'>Cancel Orders List</li>
            </ul>
    ...
    <div class="sign-in-page">
        <div class="row">
            ...
            <div class="col-md-8 mt-1">
                <h3 class="text-center"><strong class="text-warning">{{ Auth::user()->name }}</strong> Your cancel orders list</h3>
                <hr>
                        ...
                        <table id="datatable1" class="table display responsive nowrap">
                          <thead>
                            <tr>
                              ...
                              <th class="wd-10p">Cancel Date</th>
                          ...
                          <tbody>
                            ...
                            <tr>
                              ...
                              <td class="wd-10p">{{$order->cancel_date}}</td>
                              ...
                              <td class="wd-5p">
                                ...
                                <br>
                                <span class="badge badge-pill badge-warning" style="background: red; text:white;">Ordered Canceld</span>
                                </td>
